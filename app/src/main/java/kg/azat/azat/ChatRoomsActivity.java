...
import kg.azat.azat.adapter.ChatRoomsAdapter;
...
public class ChatRoomsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new ChatRoomsAdapter.RecyclerTouchListener(getApplicationContext(), recyclerView, new ChatRoomsAdapter.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(ChatRoomsActivity.this, ChatRoomMessagesActivity.class);
    ...
    private void fetchChatRooms() {
        StringRequest strReq = new StringRequest(Request.Method.GET,
                ApiHelper.CHAT_ROOMS, new Response.Listener<String>() {
    ...
    private void launchLoginActivity() {
        Intent intent = new Intent(ChatRoomsActivity.this, LoginActivity.class);
